...
<body id="page-top">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="UserController/index">All Users</a>
          </div>
        </div>
      </li>
  ...
  <?php   }else{ ?>
            <a class="collapse-item" href="AdminController/index">Login</a>
        <?php
          };
        ?>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="AdminController/logout" data-toggle="modal" data-target="#logoutModal">
